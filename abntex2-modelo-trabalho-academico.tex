...
Veremos a seguir a visão de qualidade e testes nos processos formais e nos processos ágeis. % FIXME: é bom ter referências sobre as afirmações de agil
...
Técnicas de análise estáticas não envolvem a execução de código. Revisão de documentação, de especificação de requisitos e a revisão de código são exemplos de análise estática, enquanto testes e simulações são exemplos de análise dinâmica. \cite{Huo:2004:SQA:1025117.1025549}. % pag 3 do artigo Huo 2004
...
Curioso notar que vários autores, seja em livro ou em artigos online, indicam que os Métodos Ágeis são mal compreendidos e o foco deles não são em velocidade e aumento de produtividade, mas em aumento de qualidade do projeto, e que caso seja bem aplicado e adotado, ele pode resultar em um aumento de velocidade, porém, caso contrário o uso de um Método Ágil pode resultar em um processo mais lento do que um modelo formal. \cite{galen2015} % http://www.velocitypartners.net/blog/2014/05/06/read-my-lips-agile-isnt-fast/ % Bob Galen é o mesmo que escreve o livro dos tres pilares
...
% ver se apresento/adoto o termo technical debt - dívida/débito técnico: http://www.infoq.com/br/news/2009/10/dissecting-technical-debt
...
% location 280 kindle - three pillars
Exemplo de problema encontrado por \citeonline{galen2015}: falta de conhecimento ou conhecimento superficial das técnicas. Ex.: empresa adotava a criação de testes automatizados e integração contínua, porém não sabiam criar \emph{user stories} e não sabiam indicar como uma tarefa estava concluída (\emph{Definition of Done - DoD}).
...
\citeonline{crispin2014} indica que métodos ágeis já são adotados por grande empresas, equipes distribuídas e que elas estão encontrando maneiras de gerar Produtos Minimamente Viáveis (\emph{minimum viable products - MVPs}), através de uso de entregas iterativas e rápidos processos de feedback e aprendizado.

% caso spotify, que cresceu entre 2006 à 2014 para mais 1500 funcionários em 30 países, adotavam SCRUMM e passaram a adotar um método ágil proprio pois as regras do SCRUMM foram consideradas limitantes: https://vimeo.com/85490944
% https://labs.spotify.com/2014/03/27/spotify-engineering-culture-part-1/
% spotify não possui equipes de testes, pois na cultura de desenvolvimento deles não funcionou/não foi visto vantagem
...
% - funções adicionais: um novo especialista pode ser necessário para sobrepor um obstáculo, portanto é necessário que todos saibam quais suas funções % achei este item estranho
...
% locatlion 1726 kindle - agile testing
