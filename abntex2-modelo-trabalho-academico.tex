...
\begin{figure}[h]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.85]{mcCall-graph}
    \label{fig:mcCall-quality_model}
    \legend{Fonte: Adaptação de \citeonline{Deissenboeck2009}}
\end{figure}
...
\begin{figure}[h]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.85]{boehm-hierarquia_modelo}
    \label{fig:boehm-hierarquia_modelo}
    \legend{Fonte: Adaptação de \citeonline{PFLEEGER2010}}
\end{figure}

% ================================
% =========== SUBSEÇÃO ===========
%\subsection{Modelo FURPS (\emph{Functionality, Usability, Reliability, Performance, Supportability})}
...
\begin{figure}[h]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.85]{iso9126-hierarquia_interno_externo-alt}
    \label{fig:iso9126-hierarquia_interno_externo}
    \legend{Fonte: Adaptação de \citeonline{SURYN2014}}
\end{figure}
...
\begin{figure}[H]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.7]{iso9126-hierarquia_qualidade_uso}
...
\begin{figure}[H]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.7]{iso9126-hierarquia_relacionamento}
...
\begin{figure}[H]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.7]{iso25010-hierarquia_qualidade_uso}
...
\begin{figure}[p]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.85]{iso25010-hierarquia_qualidade_produto}
...
\centering
    ...
    \end{tabular}
    \legend{Fonte: [Modificado pelo autor] \citeonline{berander2005}}
\end{table}
...
\begin{itemize}
    ...
    \item interna: quão bem um componente foi implementado de acordo com o seu uso pretendido
    \item contextual: liga com influências externas e o uso do componente
...
\begin{figure}[H]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.63]{dromey-estrutura_modelo}
...
\begin{figure}[H]
    ...
    \graphicspath{ {./graphics/} }
    \includegraphics[scale=0.74]{dromey-estrutura_modelo_exemplo}
