...
Os modelos de maturidade, que tem como foco a \emph{qualidade do processo}, serão abordados de maneira introdutória, tendo este trabalho a \emph{qualidade do produto} e os modelos de qualidade criados para ele como foco principal.
...
Este tópico vem sendo pesquisado à décadas e existe um grande número de modelos \cite{Klas2009} e seria inviável analisar todas, então focaremos nos modelos mais relevantes, seja por sua importância histórica ou por ser um padrão internacional. \citeonline{wagner2013} propõe uma divisão entre os modelos de qualidade:
\begin{itemize}
    \item \emph{Hierárquicos}: Um modelo de decomposição hierárquica dos fatores de qualidade. Ex.: McCall, Boehm, ISO 9126, ISO 25010;
...
%\citeonline{wagner2013} propôs uma extensão da classificação de modelos DAP (\emph{definition, assessment, prediction}) de \citeonline{Deissenboeck2009}:
