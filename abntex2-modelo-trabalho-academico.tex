...
\centering
    ...
    \begin{tabular}{@{}llll@{}}
        \toprule
        \textbf{Critérios/Objetivos} & \multicolumn{1}{c}{McCall} & Bohem & ISO 9126 \\ \midrule
        Exatidão & * & * & manutibilidade \\
        \rowcolor[HTML]{EFEFEF} 
        Confiabilidade & * & * & * \\
        Integridade & * & * &  \\
        \rowcolor[HTML]{EFEFEF} 
        ...
        \rowcolor[HTML]{EFEFEF} 
        Clareza &  & * &  \\
        Modificabilidade &  & * & manutibilidade \\
        \rowcolor[HTML]{EFEFEF} 
        Documentação &  & * &  \\
        Resiliência &  & * &  \\
        \rowcolor[HTML]{EFEFEF} 
        Compreensibilidade &  & * &  \\
        Validez &  & * & manutibilidade \\
        \rowcolor[HTML]{EFEFEF} 
        Funcionalidade &  &  & * \\
        Generalidade &  & * &  \\
        \rowcolor[HTML]{EFEFEF} 
        Economia &  & * &  \\ \bottomrule
    \end{tabular}
    \legend{Fonte: [Tradução do autor] \citeonline{berander2005}}
\end{table}
